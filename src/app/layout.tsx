...
export const metadata: Metadata = {
  ...
  description:
    "MobiFone Sơn La: gói cước trả trước/trả sau data khủng, eSIM tiện lợi, ưu đãi khu vực Sơn La và kho số đẹp chọn theo sở thích. Liên hệ Zalo/Email đặt SIM ngay.",
};
